...
[![CRAN
status](https://www.r-pkg.org/badges/version/nysOpenData)](https://CRAN.R-project.org/package=nysOpenData)
[![CRAN
downloads](https://cranlogs.r-pkg.org/badges/grand-total/nysOpenData?color=blue)](https://r-pkg.org/pkg/nysOpenData)
[![Lifecycle:
...
- [`nys_list_datasets()`](https://martinezc1.github.io/nysOpenData/reference/nys_list_datasets.md)
  — Browse available datasets from the live nys Open Data catalog
...
- [`nys_any_dataset()`](https://martinezc1.github.io/nysOpenData/reference/nys_any_dataset.md)
  — Pull any NYS Open Data dataset directly via its Socrata JSON
  endpoint
...
- **Ease of Use**: No need to hunt for 4x4 dataset IDs (e.g.,
  `kwxv-fwze`); use catalog-based keys instead.
